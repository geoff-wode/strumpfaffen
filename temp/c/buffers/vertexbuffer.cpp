...
{
public:
	VertexBufferImpl(const Framework::VertexDeclaration& vertexDeclaration, size_t vertexCount)
	...
	virtual const Framework::VertexDeclaration& VertexDeclaration() const
	{
		return vertexDeclaration;
	}

	size_t vertexCount;
	Framework::VertexDeclaration vertexDeclaration;
	GLuint handle;
};
